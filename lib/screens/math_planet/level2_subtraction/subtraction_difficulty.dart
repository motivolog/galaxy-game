...
class SubtractionDifficultyPage extends StatefulWidget {
  ...
  @override
  State<SubtractionDifficultyPage> createState() => _SubtractionDifficultyPageState();
}

class _SubtractionDifficultyPageState extends State<SubtractionDifficultyPage> {
